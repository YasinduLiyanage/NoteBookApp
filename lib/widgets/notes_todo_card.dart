...
class NotesTodoCard extends StatefulWidget {
  ...
  const NotesTodoCard({super.key, required this.title, required this.description, required this.icon});
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 2,),
          Text(widget.description, style: ApptextStyles.appDescriptionSmall.copyWith(color: AppColors.kWhiteColor.withOpacity(0.5))),
